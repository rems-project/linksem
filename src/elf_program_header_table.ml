...
(List.exists (fun p -> Big_int.eq_big_int (Ml_bindings.natural_of_elf32_word p.elf32_p_type) elf_pt_interp) pht)
...
(List.exists (fun p -> Big_int.eq_big_int (Ml_bindings.natural_of_elf64_word p.elf64_p_type) elf_pt_interp) pht)
