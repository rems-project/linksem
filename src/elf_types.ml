...
let instance_Basic_classes_Eq_Elf_types_unsigned_char_dict =({

  isEqual_method = Uint32_wrapper.equal;

  isInequal_method = (fun l r->not (Uint32_wrapper.equal l r))})
...
let instance_Basic_classes_Eq_Elf_types_elf32_addr_dict =({
...
let instance_Basic_classes_Eq_Elf_types_elf64_addr_dict =({

  isEqual_method = Uint64_wrapper.equal;

  isInequal_method = (fun l r->not (Uint64_wrapper.equal l r))})
...
let instance_Basic_classes_Eq_Elf_types_elf32_half_dict =({
...
let instance_Basic_classes_Eq_Elf_types_elf64_half_dict =({
...
let instance_Basic_classes_Eq_Elf_types_elf32_off_dict =({
...
let instance_Basic_classes_Eq_Elf_types_elf64_off_dict =({
...
let instance_Basic_classes_Eq_Elf_types_elf32_word_dict =({
...
let instance_Basic_classes_Eq_Elf_types_elf64_word_dict =({
...
let instance_Basic_classes_Eq_Elf_types_elf64_xword_dict =({
