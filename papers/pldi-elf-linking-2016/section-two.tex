...
Previous formal models of linking~\citep{cardelli}
...
We encountered a bug in the CIL~\citep{necula_cil_2002} C translator, which mis-compiles the \textsf{alias} attribute
...
in a document called the System V Application Binary Interface \citep{sco}.
