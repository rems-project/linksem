...
Both properties mentioned above were validated on the AARCH64, AMD64, IA32 and Power64 microarchitectures.
...
For the AARCH64 we validated our model against the contents of \texttt{usr/bin} and \texttt{usr/lib} of an LG Android~5.1.1 mobile phone.
On AARCH64, AMD64, IA32 and Power64 we tested against 576, 1650, XXX, and 1606 binaries, respectively.

\dm{run the elf counter script on the remaining platforms above}
