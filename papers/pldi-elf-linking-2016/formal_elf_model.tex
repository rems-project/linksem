...
For example, the AMD64 ABI explicitly makes reference to sections of type \texttt{STT\_GNU\_IFUNC}, a \texttt{GNU} extension, for example (see Section 4.2 of~\cite{amd64-abi}).
