...
type_synonym byte_pattern_element ="   word 8 option "
...
definition symRefCompare  :: " symbol_reference \<Rightarrow> symbol_reference \<Rightarrow> Lem_basic_classes.ordering "  where 
     " symRefCompare x1 x2 = (        
...
definition relocSiteCompare  :: " reloc_site \<Rightarrow> reloc_site \<Rightarrow> Lem_basic_classes.ordering "  where 
...
definition symRefAndRelocSiteCompare  :: " symbol_reference_and_reloc_site \<Rightarrow> symbol_reference_and_reloc_site \<Rightarrow> Lem_basic_classes.ordering "  where 
...
definition symDefCompare  :: " symbol_definition \<Rightarrow> symbol_definition \<Rightarrow> Lem_basic_classes.ordering "  where 
     " symDefCompare x1 x2 = (        
...
function (sequential,domintros)  make_byte_pattern_revacc  :: "(( word 8)option)list \<Rightarrow>( word 8)list \<Rightarrow>(bool)list \<Rightarrow>(( word 8)option)list "  where 
...
fun  make_byte_pattern  :: "( word 8)list \<Rightarrow>(bool)list \<Rightarrow>(( word 8)option)list "  where 
...
function (sequential,domintros)  relax_byte_pattern_revacc  :: "(( word 8)option)list \<Rightarrow>(( word 8)option)list \<Rightarrow>(bool)list \<Rightarrow>(( word 8)option)list "  where 
...
fun  relax_byte_pattern  :: "(( word 8)option)list \<Rightarrow>(bool)list \<Rightarrow>(( word 8)option)list "  where 
...
fun byte_option_matches_byte  :: "( word 8)option \<Rightarrow> word 8 \<Rightarrow> bool "  where 
...
function (sequential,domintros)  byte_list_matches_pattern  :: "(( word 8)option)list \<Rightarrow>( word 8)list \<Rightarrow> bool "  where 
...
definition append_to_byte_pattern_at_offset  :: " nat \<Rightarrow>(( word 8)option)list \<Rightarrow>(( word 8)option)list \<Rightarrow>(( word 8)option)list "  where 
...
function (sequential,domintros)  accum_pattern_possible_starts_in_one_byte_sequence  :: "(( word 8)option)list \<Rightarrow> nat \<Rightarrow>( word 8)list \<Rightarrow> nat \<Rightarrow> nat \<Rightarrow>(nat)list \<Rightarrow>(nat)list "  where 
...
definition pattern_possible_starts_in_one_byte_sequence  :: "(( word 8)option)list \<Rightarrow>( word 8)list \<Rightarrow> nat \<Rightarrow>(nat)list "  where 
...
fun byte_pattern_of_byte_sequence  :: " byte_sequence \<Rightarrow>(( word 8)option)list "  where 
