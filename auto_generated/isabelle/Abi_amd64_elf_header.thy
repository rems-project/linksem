chapter {* Generated by Lem from abis/amd64/abi_amd64_elf_header.lem. *}

theory "Abi_amd64_elf_header" 
...
definition abi_amd64_data_encoding  :: " nat "  where 
     " abi_amd64_data_encoding = ( elf_data_2lsb )"


(*val abi_amd64_endianness : endianness*)
definition abi_amd64_endianness  :: " endianness "  where 
     " abi_amd64_endianness = ( Little )"
 (* Must match above *)

(*val abi_amd64_file_class : natural*)
definition abi_amd64_file_class  :: " nat "  where 
     " abi_amd64_file_class = ( elf_class_64 )"


(*val abi_amd64_file_version : natural*)
definition abi_amd64_file_version  :: " nat "  where 
     " abi_amd64_file_version = ( elf_ev_current )"


(*val abi_amd64_page_size_min : natural*)
definition abi_amd64_page_size_min  :: " nat "  where 
     " abi_amd64_page_size_min = (( 4096 :: nat))"


(*val abi_amd64_page_size_max : natural*)
definition abi_amd64_page_size_max  :: " nat "  where 
     " abi_amd64_page_size_max = (( 65536 :: nat))"
...
definition is_valid_abi_amd64_machine_architecture  :: " nat \<Rightarrow> bool "  where 
...
definition is_valid_abi_amd64_magic_number  :: "(Elf_Types_Local.unsigned_char)list \<Rightarrow> bool "  where 
  ...
  (case  index magic ( elf_ii_class) of
    ...
    | Some cls =>
      (case  index magic ( elf_ii_data) of
          None   => False
        | Some data =>
            (unat cls = abi_amd64_file_class) \<and>
              (unat data = abi_amd64_data_encoding)
      )
  ))"
