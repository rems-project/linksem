...
open lem_numTheory lem_basic_classesTheory lem_maybeTheory lem_stringTheory lem_assert_extraTheory missing_pervasivesTheory errorTheory elf_types_native_uintTheory lem_mapTheory elf_symbol_tableTheory elf_relocationTheory memory_imageTheory memory_image_orderingsTheory;
...
val _ = Define `
 (size_of_def rr = (w2n rr.ref.ref_syment.elf64_st_size))`;
