...
val _ = Hol_datatype `
 elf32_relocation =
  <| elf32_r_offset :  addr 32 (** Address at which to relocate *)
   ; elf32_r_info   :  word 32 (** Symbol table index/type of relocation to apply *)
   |>`;
...
val _ = Hol_datatype `
 elf32_relocation_a =
  <| elf32_ra_offset :  addr 32  (** Address at which to relocate *)
   ; elf32_ra_info   :  word 32  (** Symbol table index/type of relocation to apply *)
   ; elf32_ra_addend :  word 32 (** Addend used to compute value to be stored *)
   |>`;
...
val _ = Hol_datatype `
 elf64_relocation =
  <| elf64_r_offset :  word 64  (** Address at which to relocate *)
...
val _ = Hol_datatype `
 elf64_relocation_a =
  <| elf64_ra_offset :  word 64   (** Address at which to relocate *)
   ; elf64_ra_info   : elf64_xword  (** Symbol table index/type of relocation to apply *)
   ; elf64_ra_addend :  word 64 (** Addend used to compute value to be stored *)
   |>`;
