...
open lem_numTheory lem_basic_classesTheory lem_boolTheory lem_stringTheory showTheory missing_pervasivesTheory byte_sequenceTheory elf_types_native_uintTheory;
...
(let zero = ((n2w : num -> 32 word)( 0)) in
  let one1  = ((n2w : num -> 32 word)( 1)) in
  let two  = ((n2w : num -> 32 word)( 2)) in
  let four = ((n2w : num -> 32 word)( 4)) in
