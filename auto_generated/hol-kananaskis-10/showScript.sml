...
open lem_numTheory lem_listTheory lem_functionTheory lem_maybeTheory lem_stringTheory lem_string_extraTheory ASCIInumbersTheory;
...
(instance_Show_Show_Num_integer_dict= (<|
  ...
  show_method := num_from_dec_string|>))`;
